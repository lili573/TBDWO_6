<!DOCTYPE html>
<html lang="en">
<!-- kapan jumlah pembelian paling banyak dalam satu tahun -->
<head>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                Berikut merupakan grafik diagram garis untuk menampilkan jumlah pembelian paling banyak dalam tahun 2003.
                </p>
                <!-- /.container-fluid -->
            </div>
            <!-- End of Main Content -->
    ...
    <script type="text/javascript">
        ...
        Highcharts.chart('linechart', {
            ...
            series: [
                ...
                {
                name: '<?= $data3[$i]["nama_produk"]; ?>',
                data: [
                    <?php for ($a=$i; $a < $i+5; $a++):?>
                        <?= $data3[$a]["total_terjual"]; ?>,
                    <?php endfor;?>
                    ]
                },
                <?php endfor;?>
