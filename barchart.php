<!DOCTYPE html>
<html lang="en">
<!-- Produk apa yang terjual paling banyak di taun 2003, ini nnti nyebutin jumlah pembelian(kiri) sm id produk(bawah).  -->
<head>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                Berikut merupakan grafik diagram batang untuk menampilkan produk apa yang terjual paling banyak dalam tahun 2003.
                </p>
                <!-- /.container-fluid -->
                ...
                series: [
                    <?php for ($i=0; $i < count($data2); $i+=5):?>
                    {
                        ...
                        data: [
                            ...
                            [
                                "<?= $data2[$a]["kategori"]; ?>",
                                <?= $data2[$a]["bulan"] > 12 ? 12 : $data["bulan"]; ?>
                            ],
                            <?php endfor;?>
                        ]
                    },
